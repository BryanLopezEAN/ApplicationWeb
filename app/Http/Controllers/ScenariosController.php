...
class ScenariosController extends Controller {
	...
	public function type($type){
		...
		$scenario = ['name' => 'Escenario 1 - ALFA', 'desc1' => 'Económico, pero cuenta con grandes salones de exposición y presentación.', 'desc2' => 'Cuenta con una amplia gama de salones y cada salón cuenta con espacio amplio de trabajo.', 'desc3' => 'Cuenta con diferentes tarimas, exclusividad a camerinos y estos a su vez cuenta con baños privados.', 'desc4' => 'Capacidad para 1500 personas y disponibilidad de mesas y sillas.', 'img1' => '/images/slide1.jpg', 'img2' => '/images/slide2.jpg', 'img3' => '/images/slide3.jpg', 'img4' => '/images/event1.jpg'];
